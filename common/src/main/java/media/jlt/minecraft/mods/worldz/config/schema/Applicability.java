...
public record Applicability(Scope scope, Set<String> presets, boolean customizeExposed) {
    ...
    public static Applicability preset(String... presetIds) {
        return new Applicability(Scope.PRESET, Set.of(presetIds), false);
    }

    /** Returns a copy with {@link #customizeExposed} set. */
    public Applicability exposedInCustomize() {
        return new Applicability(scope, presets, true);
    }
