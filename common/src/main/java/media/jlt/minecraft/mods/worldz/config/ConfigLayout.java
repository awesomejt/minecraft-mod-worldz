...
/**
 * The 26-root-key to 16-file mapping (DESIGN §43.2/§43.4.1/§45, TODO 25.7a/25.9; {@code kits} added at
...
public final class ConfigLayout {
     ...
     * world-types/worldz.yaml}); {@code kits.yaml} and all twelve
    ...
    public static final List<ConfigFile> FILES = List.of(
        ...
        new ConfigFile("world-types/strip-world.yaml", List.of("stripWorld"), true),
