...
/** Small world-creation screen for the {@code jlt_worldz:single_biome} typed preset (DESIGN §20.2). */
final class SingleBiomeCustomizeScreen extends Screen implements
    LimitEditorHosts.BorderEditorHost, LimitEditorHosts.ExteriorEditorHost, LimitEditorHosts.EndBorderEditorHost {
    private static final Component TITLE = Component.translatable("jlt_worldz.single_biome.title");
    ...
    protected void init() {
        ...
        this.landBiome = textField(Component.translatable("jlt_worldz.single_biome.land_biome"), this.landBiomeText, 256);
        this.landBiome.setResponder(value -> this.landBiomeText = value);
        form.addChild(CommonLayouts.labeledElement(
            this.font, this.landBiome, Component.translatable("jlt_worldz.single_biome.land_biome")
        ));

        this.starterBiome = textField(Component.translatable("jlt_worldz.single_biome.starter_biome"), this.starterBiomeText, 256);
        this.starterBiome.setResponder(value -> this.starterBiomeText = value);
        form.addChild(CommonLayouts.labeledElement(
            this.font, this.starterBiome, Component.translatable("jlt_worldz.single_biome.starter_biome")
        ));

        this.starterRadius = textField(Component.translatable("jlt_worldz.single_biome.starter_radius"), this.starterRadiusText, 10);
        this.starterRadius.setResponder(value -> this.starterRadiusText = value);
        form.addChild(CommonLayouts.labeledElement(
            this.font, this.starterRadius, Component.translatable("jlt_worldz.single_biome.starter_radius")
        ));
