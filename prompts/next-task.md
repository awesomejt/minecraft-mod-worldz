...
Update the Memory file with important decisions, update the TODO file with additional tasks identified and to mark tasks complete. Update documentation files as needed and create sequenced test configuration files (config/tests) for manual in-game testing. Note any blockers or questions that need answering.